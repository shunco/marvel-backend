...
-- Usuario mvasquez, pass = contrasena123
INSERT INTO "user" (username, password, role_id, account_expired, account_locked, credentials_expired, enabled) VALUES ('mvasquez', '$2a$10$ZK9Y2UfgLivxy37YPiAQWOLMsujY3XJHkRXGYz4Cv7trCZLPLqudi', 2, false, false, false, true);
-- Usuario aaquino, pass = contrasena456
INSERT INTO "user" (username, password, role_id, account_expired, account_locked, credentials_expired, enabled) VALUES ('aaquino', '$2a$10$juOXaule5VGy1KogEFCu5eFBSmZ54Wv0x1iIbaN7TpcouueD1epKy', 1, false, false, false, true);
